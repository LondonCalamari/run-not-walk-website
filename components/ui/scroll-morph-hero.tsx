  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Back Face */}
        <div
          className="absolute inset-0 h-full w-full overflow-hidden rounded-xl shadow-lg bg-[#080808] flex flex-col items-center justify-center p-4 border border-[#1F1C1A]"
          style={{ backfaceVisibility: "hidden", transform: "rotateY(180deg)" }}
        >
          <div className="text-center">
            <p className="text-[8px] font-mono text-[#FE7F2D] uppercase tracking-widest mb-1">View</p>
            <p className="text-xs font-medium text-[#F5F4F0]">Work</p>
          </div>
        </div>
      </motion.div>
    </motion.div>
...
// Unsplash Images - AI/Creative themed
const IMAGES = [
  ...
  "https://images.unsplash.com/photo-1686191128892-3b37add4a934?w=300&q=80",
  ...
  "https://images.unsplash.com/photo-1527474305487-b87b222841cc?w=300&q=80",
  ...
  "https://images.unsplash.com/photo-1563089145-599997674d42?w=300&q=80",
  "https://images.unsplash.com/photo-1634017839464-5c339ez8ebe?w=300&q=80",
  "https://images.unsplash.com/photo-1620121692029-d088224ddc74?w=300&q=80",
  "https://images.unsplash.com/photo-1535378437327-b71494669e9d?w=300&q=80",
...
export default function ScrollMorphHero() {
  ...
  useEffect(() => {
    ...
    const handleWheel = (e: WheelEvent) => {
      // At boundaries, allow native page scroll so user can leave the hero
      if (e.deltaY > 0 && scrollRef.current >= MAX_SCROLL) return;
  ...
  return (
    <div ref={containerRef} className="relative w-full h-screen bg-[#F5F4F0] overflow-hidden">
      {/* Container */}
      <div className="flex h-full w-full flex-col items-center justify-center perspective-1000">
        ...
        <div className="absolute z-0 flex flex-col items-center justify-center text-center pointer-events-none top-1/2 -translate-y-1/2">
          <motion.h1
            ...
            className="font-brand text-[clamp(3rem,8vw,6.5rem)] leading-[0.88] tracking-[0.03em] text-[#080808]"
          >
            RUN NOT WALK
          </motion.h1>
          <motion.p
            ...
            className="mt-3 font-mono text-[0.62rem] tracking-[0.28em] uppercase text-[#FE7F2D]"
          >
            AI Creative Studio
          </motion.p>
          <motion.p
            initial={{ opacity: 0 }}
            animate={introPhase === "circle" && morphValue < 0.5 ? { opacity: 1 - morphValue * 2 } : { opacity: 0 }}
            transition={{ duration: 1, delay: 0.4 }}
            className="mt-8 font-mono text-[0.58rem] tracking-[0.3em] uppercase text-[#6B6560]"
          >
            Scroll to Explore
          </motion.p>
        </div>
        ...
        >
          <h2 className="font-brand text-[clamp(2.5rem,5vw,5rem)] leading-[0.9] tracking-[0.03em] text-[#080808] mb-4">
            THE WORLD&apos;S FASTEST<br />AI CREATIVE STUDIO.
          </h2>
          <p className="font-mono text-[0.65rem] tracking-[0.2em] uppercase text-[#FE7F2D] max-w-lg">
